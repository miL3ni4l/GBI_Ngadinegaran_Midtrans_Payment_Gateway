...
class PrsmbhnPnglrnRtnController extends Controller
{
    ...
    public function persembahan_pengeluaran_rutin_print()
    {
        //Akses Dari Luar 
        if (Auth::user() == '') {
            Alert::info('Oopss..', 'Anda dilarang masuk ke area ini.');
        ...
        return view('persembahan_pengeluaran_rutin.persembahan_pengeluaran_rutin_print', ['pengeluaran_rutin' => $pengeluaran_rutin, 'kategori_pengeluaran' => $kategori_pengeluaran, 'kategori' => $kategori, 'pengeluaran_rutins' => $pengeluaran_rutins, 'datas' => $datas, 'kategoris' => $kategoris]);
    }
