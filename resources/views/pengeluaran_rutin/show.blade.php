                              ...
                              <div class="col-md-12 col-sm-12 col-12">
                                  <div class="col-md-12 col-sm-12 col-12">
                                    <ol class="breadcrumb float-sm-right">
                                      ...
                                      <li class="breadcrumb-item active">{{$pengeluaran_rutin->kode_pengeluaran_rutin}}-{{$pengeluaran_rutin->kategori_pengeluaran->kategori}}</li>
                                    </ol>
                                  </div>
                              </div> 
                          </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline">
                      <div class="mailbox-read-info">
                        <h5>
                          <b>{{$pengeluaran_rutin->kode_pengeluaran_rutin}}-{{$pengeluaran_rutin->kategori_pengeluaran->kategori}} 
                      ...
                      <div class="mailbox-read-message">
                        ...
                        <p>
                          ...
                          diambil dari kas <b>{{$pengeluaran_rutin->kas->kas}}</b>.
                        </p>
                        ...
                        <img width="250" height="250" @if($pengeluaran_rutin->cover) src="{{ asset('images/PengeluaranRutin/'.$pengeluaran_rutin->cover) }}" @endif /> 
                      </div>
                    </div>
