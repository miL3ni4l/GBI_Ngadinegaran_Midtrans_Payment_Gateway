            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col" >
                    <table >
                        <tr>
                          <td width="50%"> Petugas  <b>{{ $pengeluaran_rutin->kategori_pengeluaran->petugas['nama'] }}</b> </td>
                        </tr>

                        <tr>
                          <td width="50%">Tanggal</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pengeluaran_rutin->tanggal->format('d-M-Y')}} </small></td>
                        </tr>

                        <!-- <tr>
                          <td width="50%">Data Input</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pengeluaran_rutin->updated_at->diffForHumans()}} </small></td>
                        </tr> -->
                        ...
                        <tr>
                          ...
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pengeluaran_rutin->kategori_pengeluaran->kategori }} </small></td>
                        </tr>
                        <tr>
                          <td width="50%">Pembayaran</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pengeluaran_rutin->kas->kas }} </small></td>
                        </tr>

                        <tr>
                          <td width="50%">Nominal</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ "Rp.".number_format($pengeluaran_rutin->nominal).",-" }} </small></td>
                        </tr>
