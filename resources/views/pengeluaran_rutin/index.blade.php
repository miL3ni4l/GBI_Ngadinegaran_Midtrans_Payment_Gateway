      ...
      <div class="card-header pt-4">
        <div class="col-12">
          <h5>
            ...
            <a target="_BLANK" href="{{ route('pengeluaran_rutin_print',['kategori_pengeluaran' => $_GET['kategori_pengeluaran'],'kas' => $_GET['kas'], 'dari' => $_GET['dari'], 'sampai' => $_GET['sampai']]) }}" class="btn btn-default float-right bg-primary col-md-2 text-center"><i class="fa fa-print "></i> &nbsp; Print</a>
            ...
            <table class="table table-striped" id="example1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($t->status == '1')
                    <a href="{{ url('pengeluaran_rutin/status/'.$t->id) }}" class="btn btn-sm btn-danger col-md-11">BATALKAN</a>
                    @else
                    <a href="{{ url('pengeluaran_rutin/status/'.$t->id) }}" class="btn btn-sm btn-success col-md-11">KONFIRMASI</a>
                    @endif
                  </td>
                  @endif
                  <td class="text-left">
