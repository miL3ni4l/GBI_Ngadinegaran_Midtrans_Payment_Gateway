    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-12">
        <div class="col-md-12 col-sm-12 col-12">
          ...
          <div class="btn-group">
            <a href="{{ route('persembahan_pengeluaran_rutin.create') }}" type="button" class="btn btn-primary"><i class="fa fa-plus"></i></a>
          </div>
          ...
          <div class="btn-group">
            <a href="{{ route('konfirmasi_persembahan_rutin') }}" type="button" class="btn btn-danger">
              <i class="fas fa-inbox"></i>
            </a>
          </div>

          <div class="btn-group">
            <a href="{{ route('persembahan_pengeluaran_rutin.index') }}" type="button" class="btn btn-warning">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left">
                    ...
                    {{ $t->kode_persembahan_pengeluaran_rutin }}
                  ...
                  <td class="text-left col-md-1">
                    ...
                    @if($t->status == '1')
                    <a href="{{route('persembahan_pengeluaran_rutin.show', $t->id)}}" class="btn btn-info btn-sm  text-center" tooltip>
                      <i class="fa fa-eye text-center"></i>
                    </a>
                    <a href="{{ route('persembahan_pengeluaran_rutin.laporan', $t->id) }}" class="btn btn-success btn-sm  text-center" tooltip>
                    ...
                    <a href="{{route('persembahan_pengeluaran_rutin.edit', $t->id)}}" class="btn btn-secondary btn-sm text-center">
                    ...
                    <!-- Modal -->
                    <form action="{{ route('persembahan_pengeluaran_rutin.destroy', $t->id)}}" method="post">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <p>Apakah anda yakin ingin menghapus data <b>{{$t->kode_persembahan_pengeluaran_rutin}}</b> ?</p>
  ...
  <div class="modal-dialog modal-default modal-dialog-centered modal-" role="document">
    <div class="modal-content bg-gradient-white">
      ...
      <div class="modal-body">
        ...
        <form method="GET" action="{{ route('periode_persembahan_rutin') }}">
          ...
          <div class="form-group col-md-12">
            <div class="form-group">
              ...
              <select class="form-control" name="kategori_pengeluaran">
                ...
                <option <?php
                        if (isset($_GET['kategori_pengeluaran'])) {
                          if ($_GET['kategori_pengeluaran'] == $k->id) {
