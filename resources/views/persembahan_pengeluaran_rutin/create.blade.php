...
@section('content')
<form method="POST" action="{{ route('persembahan_pengeluaran_rutin.store') }}" enctype="multipart/form-data">
{{ csrf_field() }}
                      ...
                      <div class="card-body">
                                ...
                                <!--area ditambah   -->
                                              ...
                                              <div class="form-group{{ $errors->has('kode_persembahan_pengeluaran_rutin') ? ' has-error' : '' }}">
                                                    ...
                                                    <label for="kode_persembahan_pengeluaran_rutin" class="col-md-7 control-label">Kode Pengeluaran Rutin <b style="color:Tomato;">*</b> </label>
                                                    <div class="col-md-12">
                                                        <input id="kode_persembahan_pengeluaran_rutin" type="text" class="form-control" name="kode_persembahan_pengeluaran_rutin" value="{{ $kode }}" readonly="">
