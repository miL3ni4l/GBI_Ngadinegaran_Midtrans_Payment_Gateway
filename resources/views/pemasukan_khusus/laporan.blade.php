            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col" >
                    <table >
                        <tr>
                          <td width="50%"> Petugas  <b>{{ $pemasukan_khusus->detail_kategori->petugas['nama'] }}</b> </td>
                        </tr>

                        <tr>
                          <td width="50%">Tanggal</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pemasukan_khusus->tanggal->format('d-M-Y')}} </small></td>
                        </tr>

                        <!-- <tr>
                          <td width="50%">Data Input</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pemasukan_khusus->updated_at->diffForHumans()}} </small></td>
                        </tr> -->
                        ...
                        <tr>
                          ...
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pemasukan_khusus->detail_kategori->kategori }} </small></td>
                        </tr>
                        <tr>
                          <td width="50%">Pembayaran</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ $pemasukan_khusus->kas->kas }} </small></td>
                        </tr>

                        <tr>
                          <td width="50%">Nominal</td>
                          <td width="5%" class="text-center">:</td>
                          <td> <small class="float-right">  {{ "Rp.".number_format($pemasukan_khusus->nominal).",-" }} </small></td>
                        </tr>
