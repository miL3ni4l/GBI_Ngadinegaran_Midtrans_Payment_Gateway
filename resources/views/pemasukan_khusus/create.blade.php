...
@section('content')
<form method="POST" action="{{ route('pemasukan_khusus.store') }}" enctype="multipart/form-data">
{{ csrf_field() }}
                  ...
                  <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item active">Tambah Pemasukan Khusus</li>
                        </ol>
                    </div>
                                ...
                                <!--area ditambah   -->
                                              ...
                                              <div class="col-md-12">                               
                                                ...
                                                <select required="required" name="ibadah" class="custom-select mb-3" >
                                                  ...
                                                  <option value="{{ $i->id }}">
                                                  {{ $i->ibadah }} 
                                                  <!-- || {{ "Rp. ".number_format($pemasukan_peribadah->total -= $pengeluaran_peribadah->total)." ,-" }} -->
                                                  </option>
                                                  @endforeach
                                                </select>
                                              </div>
                                              ...
                                              <div class="container  col-md-12">                               
                                                ...
                                                <select required="required" name="kategori" class="custom-select mb-3" >
                                                  ...
                                                  @foreach($kategoris as $k)
                                                      ...
                                                      <option value="{{ $k->id }}">
                                                        {{ $k->kategori }} 
                                                        <!-- || {{ "Rp. ".number_format($pemasukan_perkategori->total -= $pengeluaran_perkategori->total)." ,-" }} -->
                                                      </option>
                                                  @endforeach 
                                                </select>
                                              </div>
