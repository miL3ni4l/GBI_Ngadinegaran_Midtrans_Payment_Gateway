    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-12">
        <div class="col-md-12 col-sm-12 col-12">
          ...
          <div class="btn-group">
            <a href="{{ route('pemasukan_khusus.create') }}" type="button" class="btn btn-primary"><i class="fa fa-plus"></i></a>
          </div>
          ...
          <div class="btn-group">
            <a href="{{ route('konfirmasi_pemasukan_khusus') }}" type="button" class="btn btn-danger">
              <i class="fas fa-inbox"></i>
            </a>
          </div>

          <div class="btn-group">
            <a href="{{route('pemasukan_khusus.index')}}" type="button" class="btn btn-warning">
          ...
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Pemasukan Khusus</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header pt-4">
        <h3 class="card-title">Filter Pemasukan Khusus</h3>
      </div>
      <!-- LOGO -->
      <div class="card-header pt-4">
        <div class="col-12">
          <h5>
            ...
            <a target="_BLANK" href="{{ route('pemasukan_khusus_print',['ibadah' => $_GET['ibadah'],'kategori' => $_GET['kategori'],'kas' => $_GET['kas'], 'dari' => $_GET['dari'], 'sampai' => $_GET['sampai']]) }}" class="btn btn-default float-right bg-primary col-md-2 text-center"><i class="fa fa-print "></i> &nbsp; Print</a>
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title">Data Pemasukan Khusus</h3>
          </div>
            ...
            <table class="table table-striped" id="example1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($t->status == '1')
                    <a href="{{ url('pemasukan_khusus/status/'.$t->id) }}" class="btn btn-sm btn-danger col-md-11">BATALKAN</a>
                    @else
                    <a href="{{ url('pemasukan_khusus/status/'.$t->id) }}" class="btn btn-sm btn-success col-md-11">KONFIRMASI</a>
                    @endif
                  </td>
                  @endif
                  <td class="text-left"> {{ $t->kode_pemasukan_khusus }} </td>
                  ...
                  <td class="text-left">
                    ...
                    @if($t->status == '1')
                    <a href="{{route('pemasukan_khusus.show', $t->id)}}" class="btn btn-info btn-sm  text-center" tooltip>
                      <i class="fa fa-eye text-center"></i>
                    </a>
                    <a href="{{ route('pemasukan_khusus.laporan', $t->id) }}" class="btn btn-success btn-sm  text-center" tooltip>
                    ...
                    <a href="{{route('pemasukan_khusus.edit', $t->id)}}" class="btn btn-secondary btn-sm text-center">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <p>Apakah anda yakin ingin menghapus data <b>{{$t->kode_pemasukan_khusus}}</b>- <b>{{$t->detail_kategori->kategori}}</b> ?</p>
  ...
  <div class="modal-dialog modal-default modal-dialog-centered modal-" role="document">
    <div class="modal-content bg-gradient-white">
      <div class="modal-header">
        <h4 class="modal-title" id="modal-title-notification">Filter Pemasukan Khusus</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        ...
        <form method="GET" action="{{ route('periode_pemasukan_khusus') }}">
          {{ csrf_field() }}
          ...
          <div class="form-group col-md-12">
            <div class="form-group">
              ...
              <select class="form-control" name="kas">
                ...
                @foreach($kas as $k)
                <option <?php if (isset($_GET['kas'])) {
                          if ($_GET['kas'] == $k->id) {
                            echo "selected='selected'";
                          }
                        } ?> value="{{ $k->id }}">{{ $k->kas }}</option>
                @endforeach
              </select>
            </div>
          </div>
