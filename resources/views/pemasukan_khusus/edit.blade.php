            ...
            <div class="card-body">
              ...
              <div class="form-group col-md-12" style="width: 100%;margin-bottom:20px">
                ...
                <select class="form-control py-0" required="required" name="ibadah" style="width: 100%">
                  ...
                  @foreach($ibadah as $i)
                  <option {{ ($pemasukan_khusus->nama_ibadah->id == $i->id ? "selected='selected'" : "") }} value="{{ $i->id }}"> {{ $no++ }}. {{ $i->ibadah }}</option>
                  @endforeach
                </select>
              </div>
              ...
              <div class="form-group col-md-12" style="width: 100%;margin-bottom:20px">
                ...
                <select class="form-control py-0" required="required" name="kategori" style="width: 100%">
                  ...
                  <option {{ ($pemasukan_khusus->detail_kategori->id == $k->id ? "selected='selected'" : "") }} value="{{ $k->id }}"> {{ $no++ }}. {{ $k->kategori }}</option>
                  @endforeach
                </select>
              </div>
              ...
              <div class="form-group col-md-12" style="width: 100%;margin-bottom:20px">
                ...
                <select class="form-control py-0" required="required" name="kas" style="width: 100%">
                  ...
                  @foreach($kas as $k)
                  <option {{ ($pemasukan_khusus->kas->id == $k->id ? "selected='selected'" : "") }} value="{{ $k->id }}"> {{ $no++ }}. {{ $k->kas }}</option>
                  @endforeach
                </select>
              </div>
