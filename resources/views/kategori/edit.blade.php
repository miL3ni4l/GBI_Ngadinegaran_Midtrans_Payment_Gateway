  ...
  <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="col-md-12 col-sm-12 col-12">
            ...
            <li class="breadcrumb-item active"> <h4>Edit Kategori Pemasukan <b> {{ $data->kode_kategori }}-{{ $data->kategori }}</b></h4>  </li>
            </ol>
            
              <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/home">Home</a></li>
              <li class="breadcrumb-item"><a href="/detail_kategori">Kategori Pemasukan</a></li>
              <li class="breadcrumb-item active">Edit Kategori Pemasukan {{ $data->kode_kategori }}-{{ $data->kategori }}</li>
              </ol>
            </div>
        </div> 
