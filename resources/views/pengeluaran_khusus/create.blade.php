...
@section('content')
<form method="POST" action="{{ route('pengeluaran_khusus.store') }}" enctype="multipart/form-data">
{{ csrf_field() }}
                                ...
                                <!--area ditambah   -->
                                                ...
                                                <select required="required" name="kategori" class="custom-select mb-3" >
                                                  ...
                                                  @foreach($kategoris as $k)
                                                      ...
                                                      <?php 
                                                        ...
                                                        ->where('status','1')
                                                        ->first();
                                                        $total_pemasukan_perkategori = $pemasukan_perkategori->total;
                                                      
                                                        $pengeluaran_perkategori_khusus = DB::table('pengeluaran_khusus')
                                                        ->select(DB::raw('SUM(nominal) as total'))
                                                        ->where('kategori_id',$id_kategori)
                                                        ->where('status','1')
                                                        ->first();
                                                        $total_pengeluaran_perkategori_khusus = $pengeluaran_perkategori_khusus->total;
                                              ...
                                              <div class="col-md-12">                               
                                                ...
                                                <select required="required" name="kas" class="custom-select mb-3" >
                                                  ...
                                                  <?php 
                                                      $id_kas = $k->id;
                                                      $pemasukan_perkas = DB::table('pemasukan_khusus')
                                                      ->select(DB::raw('SUM(nominal) as total'))
                                                      ->where('kas_id',$id_kas)
                                                      ->where('status','1')
                                                      ->first();
