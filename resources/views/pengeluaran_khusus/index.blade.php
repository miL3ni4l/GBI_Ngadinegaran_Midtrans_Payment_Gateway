    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-12">
        <div class="col-md-12 col-sm-12 col-12">
          ...
          <div class="btn-group">
            <a href="{{ route('pengeluaran_khusus.create') }}" type="button" class="btn btn-primary"><i class="fa fa-plus"></i></a>
          </div>
          ...
          <div class="btn-group">
            <a href="{{route('pengeluaran_khusus.index')}}" type="button" class="btn btn-warning">
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header pt-4">
        <h3 class="card-title">Filter Pengeluaran Khusus</h3>
      </div>
      <!-- LOGO -->
      <div class="card-header pt-4">
        <div class="col-12">
          <h5>
            ...
            <a target="_BLANK" href="{{ route('pengeluaran_khusus_print',['kategori' => $_GET['kategori'], 'dari' => $_GET['dari'], 'sampai' => $_GET['sampai']]) }}" class="btn btn-default float-right bg-primary col-md-2 text-center"><i class="fa fa-print "></i> &nbsp; Print</a>
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title">Data Pengeluaran Khusus</h3>
          </div>
            ...
            <table class="table table-striped" id="example1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($t->status == '1')
                    <a href="{{ url('pengeluaran_khusus/status/'.$t->id) }}" class="btn btn-sm btn-danger">BATALKAN</a>
                    @else
                    <a href="{{ url('pengeluaran_khusus/status/'.$t->id) }}" class="btn btn-sm btn-success">KONFIRMASI</a>
                    @endif
                  </td>
                  @endif
                  ...
                  <td class="text-left">
                    ...
                    @if($t->status == '1')
                    <a href="{{route('pengeluaran_khusus.show', $t->id)}}" class="btn btn-info btn-sm  text-center" tooltip>
                      <i class="fa fa-eye text-center"></i>
                    </a>
                    <a href="{{ route('pengeluaran_khusus.laporan', $t->id) }}" class="btn btn-success btn-sm  text-center" tooltip>
                    ...
                    <a href="{{route('pengeluaran_khusus.edit', $t->id)}}" class="btn btn-secondary btn-sm text-center">
                    ...
                    <!-- Modal -->
                    <form action="{{ route('pengeluaran_khusus.destroy', $t->id)}}" method="post">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <p>Apakah anda yakin ingin menghapus data <b>{{$t->kode_pengeluaran_khusus}}</b>- <b>{{$t->detail_kategori->kategori}}</b> ?</p>
  ...
  <div class="modal-dialog modal-default modal-dialog-centered modal-" role="document">
    <div class="modal-content bg-gradient-white">
      <div class="modal-header">
        <h4 class="modal-title" id="modal-title-notification">Filter Pengeluaran Khusus</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
