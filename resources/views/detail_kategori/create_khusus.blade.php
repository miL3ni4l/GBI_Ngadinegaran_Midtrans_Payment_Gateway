  ...
  <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="col-md-12 col-sm-12 col-12">
            ...
            <li class="breadcrumb-item active"><h4>Tambah Kategori Khusus</h4> </li>
            </ol>
            
              <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/home">Home</a></li>
              <li class="breadcrumb-item"><a href="/detail_kategori">Kategori Pemasukan</a></li>
              <li class="breadcrumb-item active">Tambah Kategori Khusus</li>
              </ol>
            </div>
        </div> 
        ...
        <div class=" table-responsive col-md-12 col-sm-6 col-12">     
          <div class="card card-secondary">
            <div class="card-body">
            <form method="POST" action="{{ route('store_khusus') }}" enctype="multipart/form-data">
  {{ csrf_field() }}
...
<!--                                                     
                                                ...
                                                <div class="form-group{{ $errors->has('jenis') ? ' has-error' : '' }}">
                                                                <div class="col-md-12">
                                                                    <input id="jenis" type="hidden" class="form-control" name="jenis" value="Khusus" placeholder="Masukkan Nama Kategori . . ." required>
