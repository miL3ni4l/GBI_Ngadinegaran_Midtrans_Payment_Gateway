      ...
      <div class="row">
                        <div class="col-md-12 col-sm-12 col-12">
                            <div class="col-md-12 col-sm-12 col-12">
                                  ...
                                  <div class="btn-group">
                                    <a href="{{ route('petugas.create') }}"  type="button" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                  </div>
                                  ...
                                  <div class="btn-group">
                                    <a  href="{{route('petugas.index')}}" type="button" class="btn btn-warning">
                              ...
                              <div class="card bg-light d-flex flex-fill">
                                  ...
                                  <div class="card-body pt-0">
                                    <div class="row">
                                      ...
                                      <h2 class="lead"><b>{{ $p->nama }}</b> </h2>
                                        ...
                                        <p class="text-muted text-sm"><b>Last sign in : </b> {{ $p->user->updated_at->diffForHumans()  }}</p>
                                        <ul class="ml-4 mb-0 fa-ul text-muted">
                                          ...
                                          @endif
                                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> E-mail : {{ $p->user->email }}</li>
                                      ...
                                      <div class="col-5 text-center">
                                            @if($p->user->foto)
                                              <img src="{{url('images/user', $p->user->foto)}}" alt="image" style="margin-right: 1px;" width="125" height="125" class="img-circle img-fluid" />
                                            @else
                                              @if($p->jk == 'L') 
                                                <img src="{{url('/adminlte/img/avatar4.png')}}" alt="image" style="margin-right: 1px;" width="125" height="125" class="img-circle img-fluid" />
                                              @else
                                                <img src="{{url('/adminlte/img/avatar2.png')}}" alt="image" style="margin-right: 1px;" width="125" height="125" class="img-circle img-fluid" />
                                              @endif
                                            @endif
                                      </div>
                                    </div>
                                  ...
                                  <div class="card-footer float-right">
                                    <div>
                                                          ...
                                                          <a href="{{route('petugas.edit', $p->id)}}" class="btn btn-secondary btn-sm text-center">
