  ...
  <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="col-md-12 col-sm-12 col-12">
            ...
            <li class="breadcrumb-item active"> <h4>Edit Kategori <b> {{ $data->kategori }}</b></h4>  </li>
            </ol>
            
              <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/home">Home</a></li>
              <li class="breadcrumb-item"><a href="/detail_pengeluaran">Kategori</a></li>
              <li class="breadcrumb-item active">Edit Kategori {{ $data->kategori }}</li>
              </ol>
            </div>
        </div> 
        ...
        <div class=" table-responsive col-md-12 col-sm-6 col-12">     
          <div class="card card-secondary">
            <div class="card-body">
            <form action="{{ route('detail_pengeluaran.update', $data->id) }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
        {{ method_field('put') }}
                                                ...
                                                <div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }}">
                                                    <label for="kategori" class="col-md-4 control-label">Kategori  <b style="color:Tomato;">*</b> </label>
                                                    <div class="col-md-12">
