      ...
      <div class="card-header pt-4">
        <div class="col-12">
          <h5>
            ...
            <a target="_BLANK" href="{{ route('persembahan_print',['kategori' => $_GET['kategori'], 'dari' => $_GET['dari'], 'sampai' => $_GET['sampai']]) }}" class="btn btn-default float-right bg-primary col-md-2 text-center"><i class="fa fa-print "></i> &nbsp; Print</a>
