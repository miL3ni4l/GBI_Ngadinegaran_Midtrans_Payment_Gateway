      ...
      <div class="card-header pt-4">
        <div class="col-12">
          <h5>
            ...
            <a target="_BLANK" href="{{ route('persembahan_pengeluaran_khusus_print',['kategori' => $_GET['kategori'], 'dari' => $_GET['dari'], 'sampai' => $_GET['sampai']]) }}" class="btn btn-default float-right bg-primary col-md-2 text-center"><i class="fa fa-print "></i> &nbsp; Print</a>
            ...
            <table class="table table-striped" id="example1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($t->status == '1')
                    <a href="{{ url('persembahan_pengeluaran_khusus/status/'.$t->id) }}" class="btn btn-sm btn-danger col-md-12">BATALKAN</a>
                    @else
                    <a href="{{ url('persembahan_pengeluaran_khusus/status/'.$t->id) }}" class="btn btn-sm btn-success col-md-12">KONFIRMASI</a>
                    @endif
                  </td>
                  @endif
