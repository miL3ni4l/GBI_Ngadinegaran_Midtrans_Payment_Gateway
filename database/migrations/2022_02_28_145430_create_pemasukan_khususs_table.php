...
class CreatePemasukanKhusussTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pemasukan_khusus', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('kode_pemasukan_khusus');      
            $table->date('tanggal');
    ...
    {
        Schema::dropIfExists('pemasukan_khusus');
    }
}
